...
class UpdatePessoa extends React.Component {
  ...
  update = () => {
    axios.put(`http://localhost:8080/api/pessoa/${this.state.id}`,
      {
          ...
          <div className='col-md-12' style={this.styles.colMd12}>
            <div className="bs-docs-section">
              ...
              <div className="card border-primary mb-3" style={this.styles.cardBorder}>
                <h3 className="card-header text-center">Atualização de Pessoas</h3>
                      ...
                      <div className='bs-component'>
                        ...
                        <div className="form-group">
                          ...
                          <div className="form-floating mb-3">
                            ...
                            <label htmlFor="inputId">Digite o Id da Pessoa</label>
                          </div>
                        </div>
...
export default withRouter(UpdatePessoa);